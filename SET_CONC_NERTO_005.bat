...
%EXEC_DIR%con2stn -i%grid%.bin -o%grid%.con2stn+20deg.txt -c0.4522E+09 -xi -sstation_list.txt -z0 -r0 -a20.0:%LAT%:%LONG%
%EXEC_DIR%con2stn -i%grid%.bin -o%grid%.con2stn-20deg.txt -c0.4522E+09 -xi -sstation_list.txt -z0 -r0 -a-20.0:%LAT%:%LONG%
%EXEC_DIR%con2stn -i%grid%.bin -o%grid%.con2stn+25deg.txt -c0.4522E+09 -xi -sstation_list.txt -z0 -r0 -a25.0:%LAT%:%LONG%
%EXEC_DIR%con2stn -i%grid%.bin -o%grid%.con2stn-25deg.txt -c0.4522E+09 -xi -sstation_list.txt -z0 -r0 -a-25.0:%LAT%:%LONG%
...
IF EXIST %grid%.con2stn-15deg.txt rename %grid%.con2stn-15deg.txt %run_name%.%grid%.con2stn-15deg.txt
IF EXIST %grid%.con2stn+20deg.txt rename %grid%.con2stn+20deg.txt %run_name%.%grid%.con2stn+20deg.txt
IF EXIST %grid%.con2stn-20deg.txt rename %grid%.con2stn-20deg.txt %run_name%.%grid%.con2stn-20deg.txt
IF EXIST %grid%.con2stn+25deg.txt rename %grid%.con2stn+25deg.txt %run_name%.%grid%.con2stn+25deg.txt
IF EXIST %grid%.con2stn-25deg.txt rename %grid%.con2stn-25deg.txt %run_name%.%grid%.con2stn-25deg.txt
...
IF EXIST %run_name%.%grid%.con2stn+15deg.txt MOVE %run_name%.%grid%.con2stn+15deg.txt %RESULTS_DIR%
IF EXIST %run_name%.%grid%.con2stn-20deg.txt MOVE %run_name%.%grid%.con2stn-20deg.txt %RESULTS_DIR%
IF EXIST %run_name%.%grid%.con2stn+20deg.txt MOVE %run_name%.%grid%.con2stn+20deg.txt %RESULTS_DIR%
IF EXIST %run_name%.%grid%.con2stn-25deg.txt MOVE %run_name%.%grid%.con2stn-25deg.txt %RESULTS_DIR%
IF EXIST %run_name%.%grid%.con2stn+25deg.txt MOVE %run_name%.%grid%.con2stn+25deg.txt %RESULTS_DIR%
